...
async def test_add_legal_entity(
    ...
    response = await test_app.post(
        f"/api/legal-entities/add?company={seed_company.id}",
        headers=headers,
        json=data,
    )
...
async def test_edit_legal_entity(
    ...
    response = await test_app.patch(
        f"/api/legal-entities/{seed_legal_entity.id}?company={seed_company.id}",
        headers=headers,
        json=new_data,
    )
...
@pytest.mark.asyncio
async def test_get_legal_entities_by_company(
    test_app: AsyncClient,
    jwt_token_admin: dict,
    seed_legal_entity: LegalEntity,
    seed_company: Company,
    ...
    response = await test_app.get(
        f"/api/legal-entities/get-by-company?company_id={seed_company.id}",
        headers=headers,
    )
