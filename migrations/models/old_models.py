...
class ApiToken(Model):
    ...
    user = fields.ForeignKeyField(
        "diff_models.User", related_name="api_tokens", on_delete=fields.CASCADE
    )
    application = fields.ForeignKeyField(
        "diff_models.Application", related_name="api_tokens", on_delete=fields.CASCADE
    )
...
class RolePermissionRelation(Model):
    ...
    permission = fields.ForeignKeyField(
        "diff_models.Permission",
        related_name="role_permission_relations",
        on_delete=fields.CASCADE,
    )
    restriction = fields.ForeignKeyField(
        "diff_models.Restriction",
        related_name="role_permission_relations",
        null=True,
