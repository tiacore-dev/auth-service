permissions = [
    ...
    # Templates
    ("add_template", "Добавление шаблона", "crm_app, parcel_app"),
    ("edit_template", "Редактирование шаблона", "crm_app, parcel_app"),
    ("delete_template", "Удаление шаблона", "crm_app, parcel_app"),
    ("view_template", "Просмотр шаблона", "crm_app, parcel_app"),
    ("download_template", "Скачивание шаблона", "crm_app, parcel_app"),
    ("generate_template", "Генерация документа по шаблону", "crm_app, parcel_app"),
    ("get_all_templates", "Просмотр всех шаблонов", "crm_app, parcel_app"),
    # Bank Accounts
