...
permissions = [
    ...
    # Bots:
    ("add_bot", "Добавление бота"),
    ("delete_bot", "Удаление бота"),
    ("view_bot", "Просмотр бота"),
    ("get_all_bots", "Просмотр всех ботов"),
    # Get:
    ("get_all_chats", "Просмотр всех чатов"),
    ("get_all_accounts", "Просмотр всех тг аккаунтов"),
    # Prompts
    ("add_prompt", "Добавление промпта"),
    ("edit_prompt", "Редактирование промпта"),
